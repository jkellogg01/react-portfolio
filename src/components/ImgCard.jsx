export default function ImageCard({ title, children, imgPath, imgAlt }) {
  return (
    <figure className="flex flex-col lg:flex-row justify-start items-start bg-violet-900 rounded-2xl">
      <img
        src={imgPath || "https://placehold.co/500"}
        alt={imgAlt || "Placeholder alt text"}
      ...
      <div className="p-8 lg:h-full w-full">
        ...
        <div className="max-w-md py-4 text-2xl h-full">{children}</div>
      </div>
    </figure>
  );
}
